...
function SearchBar() {
  ...
  return (
    ...
    <div className="flex items-center justify-center p-4 w-search navfirst:max-w-search ">
      ...
      <div onClick={( () => setSearchopen(!searchopen))} className=" ml-2 big:hidden flex min-w-10 min-h-10 rounded-full bg-secondary margin:ml-4 justify-center items-center hover:bg-neutral-600">
      <FaSearch className="text-text" />
      </div>
